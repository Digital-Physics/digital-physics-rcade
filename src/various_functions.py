...
def draw_background():
    ...
    if gv.level == 0:
        for x in range(6):
            gv.screen.blit(gv.stars_img, (int(x * width - gv.bg_scroll * 0.5), 0))
            gv.screen.blit(gv.pine1_img, (int(x * width - gv.bg_scroll * 0.7), gv.SCREEN_HEIGHT - gv.pine1_img.get_height() - 250))
            gv.screen.blit(gv.pine2_img, (int(x * width - gv.bg_scroll * 0.8), gv.SCREEN_HEIGHT - gv.pine2_img.get_height()))
    elif gv.level == 1:
        ...
        for x in range(6):
            gv.screen.blit(gv.rotated_stars_img, (0, int(x * width - gv.bg_scroll * 0.5) - 300))
